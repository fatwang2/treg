...
| `architecture/composition.md` | `bootstrap.py`, `mcp_oauth.py`, `session.py`, `admin.py`, `web.py`, `dump_surface.py` |
...
| `architecture/multi-tenancy.md` | `models.py`, `api.py`, `access.py`, `session.py`, `db.py`, `test_router_dependencies.py` |
...
| `interface/api.md` | `sitetrack.js`, `api.py`, `__init__.py`, `admin.py`, `auth_helpers.py`, `catalog.py`, `signup_cookies.py`, `web.py`, `access.py`, `mcp_oauth.py`, `session.py`, `timeutil.py`, `catalog_store.py`, `email.py`, `runner.py`, `ratestore.py` |
