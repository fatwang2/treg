...
| `src/treg/application/signup.py` | architecture/multi-tenancy.md, interface/api.md |
...
| `interface/api.md` | `sitetrack.js`, `api.py`, `auth.py`, `signup.py`, `__init__.py`, `admin.py`, `auth.py`, `auth_helpers.py`, `catalog.py`, `signup_cookies.py`, `web.py`, `access.py`, `mcp_oauth.py`, `session.py`, `timeutil.py`, `catalog_store.py`, `email.py`, `runner.py`, `ratestore.py` |
