...
| `architecture/composition.md` | `bootstrap.py`, `mcp_oauth.py`, `session.py`, `admin.py`, `auth.py`, `orgs.py`, `web.py`, `dump_surface.py` |
...
| `architecture/multi-tenancy.md` | `models.py`, `api.py`, `auth.py`, `signup.py`, `teams.py`, `access.py`, `session.py`, `auth.py`, `orgs.py`, `db.py`, `test_router_dependencies.py` |
...
| `interface/api.md` | `sitetrack.js`, `api.py`, `auth.py`, `signup.py`, `__init__.py`, `admin.py`, `auth.py`, `auth_helpers.py`, `catalog.py`, `orgs.py`, `signup_cookies.py`, `web.py`, `access.py`, `teams.py`, `mcp_oauth.py`, `session.py`, `timeutil.py`, `catalog_store.py`, `email.py`, `runner.py`, `ratestore.py` |
