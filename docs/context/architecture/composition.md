...
project, policy, settings, usage, and budget blocks; the resources module defines secret CRUD; the
Catalog and web modules define their concern-specific blocks; and the admin module defines read,
